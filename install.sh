#!/bin/bash
# One-shot Hyprland + Pywal + Tofi bootstrap (Arch Linux)
# Fully automatic: installs packages, AUR, creates all configs + scripts
...
echo
ok "All done! Reboot and choose Hyprland on login."
echo "Tip: SUPER+E opens the wallpaper switcher."